...
const clearAllPanels = () => {
    ...
    [...document.querySelectorAll(`.game-panel-groups__item`)].forEach(e => e.remove())
}
...
const addLevelToPanel = level => {
    ...
    panelLevels.insertAdjacentHTML('beforeend',
        `<div 
            ...
            id="level-${level.id}"
        >
            <input name="name" value=${level.name} onChange="levelChange(this)"}>
